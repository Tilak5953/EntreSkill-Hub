...
export default function Footer() {
  ...
  const footerLinks = {
    platform: [
      { label: 'Business Recommendations', href: '#' },
  ...
  return (
    <footer className="bg-gray-950 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs mb-6">
              Empowering entrepreneurs by transforming skills into sustainable micro-businesses. 
              Your journey to startup success starts here.
            </p>
            {/* Social links */}
            <div className="flex gap-3">
              {['twitter', 'linkedin', 'github', 'instagram'].map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-gray-800 hover:bg-primary-600 flex items-center justify-center transition-all duration-200 hover:scale-110"
                >
        ...
        {/* Bottom bar */}
        <div className="border-t border-gray-800 py-8 flex flex-col gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 text-gray-500 text-sm">
              ...
              <span>by</span>
              <span className="text-primary-400 font-semibold">Tilak Kumar</span>
            </div>
          </div>
          {/* Internship badge */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-3 border-t border-gray-800/60">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <span>PS-II Internship Project</span>
              <span className="text-gray-700">•</span>
              <span className="text-gray-500 font-medium">BML Munjal University</span>
            </div>
            <div className="flex items-center gap-2 text-xs text-gray-600">
              <span>Station:</span>
              <span className="text-primary-500 font-semibold">Unified Mentor</span>
            </div>
          </div>
        </div>
      </div>
...
function SocialIcon({ name }) {
  const icons = {
    twitter: (
      <svg className="w-4 h-4 fill-current text-gray-400 group-hover:text-white" viewBox="0 0 24 24">
