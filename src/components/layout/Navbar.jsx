...
// Includes links to all pages including Assessment and Dashboard
// -- Tilak Kumar
      ...
      {navLinks.map((link) => {
        ...
        return (
          <Tag
            ...
            className={`${baseClass} ${!mobile && isActive ? 'nav-link-active' : ''}`}
            onClick={onClose}
          >
            {link.label}
          </Tag>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link to="/login" id="nav-login-btn" className="btn-ghost">
              Login
            </Link>
